...
bench_external_sort-memory: bench_external_sort_tpie.cpp
	g++ -o $@ bench_external_sort_tpie.cpp -I$(TPIEMEMORY) -I$(TPIEMEMORY)/Release -L$(TPIEMEMORY)/Release/tpie -ltpie -lboost_date_time -lboost_thread -lboost_filesystem -lboost_system -O3 -DNDEBUG

bench_external_sort-filestream: bench_external_sort_tpie.cpp
	g++ -o $@ bench_external_sort_tpie.cpp -I$(TPIEFILESTREAM) -I$(TPIEFILESTREAM)/Release -L$(TPIEFILESTREAM)/Release/tpie -ltpie -lboost_date_time -lboost_thread -lboost_filesystem -lboost_system -O3 -DNDEBUG

bench_external_sort-stxxl: bench_external_sort_stxxl.cpp
